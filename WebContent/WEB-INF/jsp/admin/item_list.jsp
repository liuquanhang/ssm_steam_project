...
<html>
    ...
    <body class="side_menu_active side_menu_expanded">
                                    ...
                                    <table class="table table-yuk2 toggle-arrow-tiny" id="footable_demo" data-filter="#textFilter" data-page-size="10">
                                        ...
                                        <tbody id="item_info_date">
	                                        	<tr>
	                                                ...
	                                                <td>${item.is_hot_sale==true?'热门':'否' }</td>
	                    ...
	                    <form class="form-horizontal" id="search_tagsAndplatfromLayer" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<c:forEach items="${tagidsList}" var="dict_tagids">
									<label><input type="checkbox" name="search_tag" value="${dict_tagids.dict_id}">${dict_tagids.dict_item_name}</label>&nbsp;&nbsp;
									</c:forEach>
        ...
        <!-- 自定义·js -->
        <script src="${pageContext.request.contextPath}/admin/js/sikiedu_steam.js"></script>
		...
		$("#edit_items_form")[0].reset();
			$.ajax({
				...
				success:function(data){
					...
					$("#edit_item_original_price").val(data.original_price);
					$("#edit_item_release_date").val(data.item_release_date);
					if(null != data.item_cap_iamge){
