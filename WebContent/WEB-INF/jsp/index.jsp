					...
					<div id="top_item_list">
						...
						<a href="#" class="tab_item   app_impression_tracked">
							...
							<div class="tab_item_content">
								...
								<input type="hidden" class="tab_item_plataform" value="${item.item_platform}">
...
<script type="text/javascript">
	...
	function init(){
		...
		//获取平台id字符串数组
		var platformList = $(".tab_item_plataform");
		//获取要添加到的div数组
		//标签
		...
		$.ajax({
			...
			for (var i = 0; i < data.length; i++) {
				...
				//	<!-- 隐藏域  获取平台 标签 id字符串-->
					...
					'<input type="hidden" class="tab_item_plataform" value="'+data[i].item_platform+'">'+
					'<div class="tab_item_details">'+
				//		<!-- 平台 -->
				//		<!-- 标签 -->
						'<div class="tab_item_top_tags">'+																				
